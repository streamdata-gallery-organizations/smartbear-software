...
- name: TestServer REST API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/smartbear-software/master/_listings/smartbear-software/readyapi-executions-executionid-transactions-transactionid-get.md
x-common:
- type: x-blog
